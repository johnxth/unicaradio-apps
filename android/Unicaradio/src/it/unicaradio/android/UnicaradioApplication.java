 ...
 * @author Paolo Cortis
 */
@ReportsCrashes(formKey = "", formUri = "http://unicaradio.slack-counter.org/submit.php",
...
//@ReportsCrashes(formKey = "", formUri = "http://acrastats.slackcnt.intra/server/report.php")
